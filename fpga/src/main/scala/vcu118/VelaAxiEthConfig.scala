...
// =============================================================================
// VCU118 configs using the Xilinx AXI 1G/2.5G Ethernet Subsystem + AXI DMA
// (replaces IceNIC). See generators/velaeth/src/main/scala/VelaAxiEth.scala.
//
// Key differences vs. WithVCU118RJ45Tweaks (VelaEthConfig.scala):
...
/** VCU118 tweak chain with the AXI-Ethernet+DMA NIC instead of IceNIC. */
class WithVCU118AxiEthTweaks extends Config(
  // clocking
 ...
 */
class VelaAxiEthTestVCU118 extends Config(
  new WithFPGAFrequency(100) ++
  new WithVCU118AxiEthTweaks ++
...
class VelaVPURocket1CoreDedicatedNPU50MHz extends Config(
  new WithFPGAFrequency(50) ++ // 90MHz: reduced from 100MHz to close timing on Gemmini paths
  new WithVCU118AxiEthTweaks ++
//  new WithNumofMemory ++ //for proFPGA
