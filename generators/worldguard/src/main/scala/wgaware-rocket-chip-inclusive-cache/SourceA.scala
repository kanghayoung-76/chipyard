...
class WGSourceARequest(params: InclusiveCacheParameters, widBits: Int) extends InclusiveCacheBundle(params)
{
...
class WGSourceA(params: InclusiveCacheParameters, widBits: Int) extends Module
{
  val io = IO(new Bundle {
    val req = Flipped(Decoupled(new WGSourceARequest(params, widBits)))
