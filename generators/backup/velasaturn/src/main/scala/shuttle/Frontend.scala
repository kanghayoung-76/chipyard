...
import velasaturn.backend.{VectorBackend}
import velasaturn.mem.{ScalarMemOrderCheckIO, MemRequest, TLSplitInterface, SGTLInterface}
import velasaturn.frontend.{EarlyTrapCheck, IterativeTrapCheck}
