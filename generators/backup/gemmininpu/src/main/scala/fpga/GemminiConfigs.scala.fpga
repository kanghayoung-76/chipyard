...
case class GemminiArrayConfig[T <: Data : Arithmetic, U <: Data, V <: Data](
                                                                             ...
                                                                             // Number of RegNext stages inside acc_scale_args.scale_func.
                                                                             // AccumulatorScale delays in.valid by this amount so that
                                                                             // activated_data is stable before Pipeline latches it.
                                                                             acc_scale_internal_latency: Int = 0,
