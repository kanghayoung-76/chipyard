...
/*  val internal_latency = mvin_scale_args.internal_latency
  // scale_func may contain internal RegNext stages (internal_latency cycles).
  // Delay all non-data fields by the same amount so valid/id/index stay aligned with data.
